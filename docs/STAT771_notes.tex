...
\subsection{Floating Point Format}\label{floating-point-format}
...
\subsection{IEEE Standards}\label{ieee-standards}
...
\subsection{Theoretical Problems}\label{theoretical-problems}
...
\subsection{Theoretical problems}\label{theoretical-problems-2}
