...
```{exercise, q1301}
Show that the procedure \@ref(conjugated_gradients) is the same as the one implemented in code provided by Patel.
```
...
```{exercise, q1303}
Show that the limit in \@ref(exm:gradient-example) holds. 
```
