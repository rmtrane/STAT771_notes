...
```{solution}
$\tau_a$ = machine epsilon

$\tau_r$ = right hand side of above inequality
```
...
```{solution}
Nocedal 8.1 (pp197-198)

(Takeaway - same as above, but iterate over standard basis vectors to generate columns of Jacobian matrix)
```
